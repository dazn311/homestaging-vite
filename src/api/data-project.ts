...
export const dataProject:TProject[] = [
  {
    ...
    "street": "Кронштадтский бул., 8к2п1",
    "url": "/projects/5",
    "dataDoc":[
      "Евродвушка",
  ...
  },
  {
    ...
    "dataWork":[
      "отрегулировали окна, поставили москитные сетки",
      "поменяли унитаз, и все смесители от застройщика",
      "покрасили стены",
      "перенесли розетки в спальне и гостинной",
  ...
  },
  {
    ...
    "dataWork":[
      ...
      "покраска стен, замена плинтусов",
      "перенос розеток",
  ...
  },
  {
    ...
    "dataWork":[
      "регулировка окон",
      "установка зеркала на входную дверь",
      "покраска стен и установка молдингов",
      "установка кондиционеров (3 штуки)",
      "монтаж гигиенического душа в санузле",
      "перенос розеток",
    ],
    "images": [
  ...
  },
  {
    ...
    "dataWork":[
      "регулировка окон",
      "установка дверей",
      "установка зеркал, плинтуса, молдингов и их покраска",
      "сборка мебели",
    ],
    "images": [
  ...
  {
    "id": "kronstadskii8k2p2",
    "document_id": "8",
    "jkName": "kronstadskii",
    "jkTitle": "ЖК Кронштадтский",
    "street": "Кронштадтский бул., 8к2п2",
    "url": "/projects/7",
    "dataDoc":[
      "Студия",
      "Комплектация \"Под ключ\"",
